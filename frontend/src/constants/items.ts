...
export const SHOP_ITEMS: Item[] = [
  // ─── WEAPONS ───────────────────────────────────
  { id: "s1",  name: "Dagger",         type: "weapon", hands: 1, damage: "1d4",  damageType: "piercing",    properties: ["finesse", "light", "thrown"],              range: 5,  value: 2,   description: "Light and quick blade. Favored by scouts and rogues." },
  { id: "s1b", name: "Shortsword",     type: "weapon", hands: 1, damage: "1d6",  damageType: "slashing",    properties: ["finesse", "light"],                        range: 5,  value: 10,  description: "A nimble blade balanced for speed." },
  { id: "s1c", name: "Handaxe",        type: "weapon", hands: 1, damage: "1d6",  damageType: "slashing",    properties: ["light", "thrown"],                         range: 5,  value: 5,   description: "A small axe light enough to throw." },
  { id: "s1d", name: "Mace",           type: "weapon", hands: 1, damage: "1d6",  damageType: "bludgeoning", properties: [],                                          range: 5,  value: 5,   description: "Solid flanged head. Effective against armor." },
  { id: "s1e", name: "Quarterstaff",   type: "weapon", hands: 1, damage: "1d6",  damageType: "bludgeoning", properties: ["versatile"],                               range: 5,  value: 2,   description: "Simple but versatile. Can be wielded with two hands for more force." },
  { id: "s2",  name: "Longsword",      type: "weapon", hands: 1, damage: "1d8",  damageType: "slashing",    properties: ["versatile"],                               range: 5,  value: 15,  description: "Classic straight blade. Two-handed grip delivers a stronger blow." },
  { id: "s2b", name: "Battleaxe",      type: "weapon", hands: 1, damage: "1d8",  damageType: "slashing",    properties: ["versatile"],                               range: 5,  value: 10,  description: "A broad blade that can be gripped with two hands for greater power." },
  { id: "s3",  name: "Greatsword",     type: "weapon", hands: 2, damage: "2d6",  damageType: "slashing",    properties: ["heavy", "two-handed"],                     range: 5,  value: 50,  description: "A massive, heavy blade that demands two hands. Maximum raw damage." },
  { id: "s4",  name: "Halberd",        type: "weapon", hands: 2, damage: "1d10", damageType: "slashing",    properties: ["heavy", "two-handed", "reach"],            range: 10, value: 20,  description: "Polearm combining axe and spear. Attacks enemies 2 tiles away." },
  { id: "s5",  name: "Rapier",         type: "weapon", hands: 1, damage: "1d8",  damageType: "piercing",    properties: ["finesse"],                                 range: 5,  value: 25,  description: "Elegant piercing blade. Uses STR or DEX — whichever is higher." },
  { id: "s6",  name: "Spear",          type: "weapon", hands: 1, damage: "1d6",  damageType: "piercing",    properties: ["versatile", "reach"],                      range: 10, value: 1,   description: "Simple thrusting weapon. Reach allows attacking 2 tiles away." },
  { id: "s7",  name: "Light Crossbow", type: "weapon", hands: 2, damage: "1d8",  damageType: "piercing",    properties: ["two-handed", "loading"],                   range: 40, value: 25,  description: "Compact crossbow. Must reload between shots." },
  { id: "s7b", name: "Heavy Crossbow", type: "weapon", hands: 2, damage: "1d10", damageType: "piercing",    properties: ["heavy", "two-handed", "loading"],          range: 60, value: 50,  description: "Powerful crossbow with devastating range. Must reload after each shot." },
  // ─── ARMOR ─────────────────────────────────────
  { id: "s8",  name: "Leather Armor",  type: "armor",  ac: 13, value: 10,  description: "Supple leather. AC 13. Allows full DEX modifier." },
